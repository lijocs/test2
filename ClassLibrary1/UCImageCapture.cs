...
{
    [ProgId("ClassLibrary1.UCImageCapture")]
    [ClassInterface(ClassInterfaceType.AutoDual)] //Implementing interface that will be visible from JS
    [Guid("5D03FABF-52C3-45d9-A48A-EFB6D64C9477")]
    [ComVisible(true)]

    public partial class UCImageCapture : UserControl
    {
        WebCam oWebCam = new WebCam();
        public UCImageCapture()
        {
            InitializeComponent();
            Start();
        }
        ...
        private void UCImageCapture_Load(object sender, EventArgs e)
        {

        }
    }

    [Guid("4225B128-76DC-4507-8606-ECE579DDDBFC")]
